...
import { GenericDeleteDialogComponent } from 'app/entities/generic/generic-delete-dialog.component';
import { GenericService } from 'app/entities/generic/generic.service';

describe('Component Tests', () => {
  describe('Generic Management Delete Component', () => {
    let comp: GenericDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GenericDeleteDialogComponent, '')
        .compileComponents();
