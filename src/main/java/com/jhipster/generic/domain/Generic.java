...
public class Generic implements Serializable {
    ...
    public Generic genericOneToManies(Set<GenericOneToMany> genericOneToManies) {
        this.genericOneToManies = genericOneToManies;
        return this;
    }

    public Generic addGenericOneToMany(GenericOneToMany genericOneToMany) {
        this.genericOneToManies.add(genericOneToMany);
        genericOneToMany.setGeneric(this);
        return this;
    }

    public Generic removeGenericOneToMany(GenericOneToMany genericOneToMany) {
        this.genericOneToManies.remove(genericOneToMany);
        genericOneToMany.setGeneric(null);
        return this;
    }
